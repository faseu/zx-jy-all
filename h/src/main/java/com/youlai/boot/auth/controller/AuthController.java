...
public class AuthController {
    ...
    public Result<AuthenticationToken> login(
            ...
            @Parameter(description = "验证码KEY", example = "d2e56f7g8h9j0") @RequestParam String captchaKey,
            @Parameter(description = "验证码", example = "8s9k") @RequestParam String captchaCode
    ) {
        AuthenticationToken authenticationToken = authService.login(username, password, captchaKey, captchaCode);
