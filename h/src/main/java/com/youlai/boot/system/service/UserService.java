...
public interface UserService extends IService<User> {
    ...
    IPage<UserPageVO> getProvinceUserPage(UserPageQuery queryParams);
    IPage<UserPageVO> getPrisonUserPage(UserPageQuery queryParams);
     ...
     */
    boolean updateUserPermission(Long userId, UserForm userForm);
    /**
     * 修改用户管理区域
     *
     * @param userId   用户ID
     ...
     * @return {@link Boolean} 是否修改成功
     */
    boolean updateUserArea(Long userId, UserForm userForm);
